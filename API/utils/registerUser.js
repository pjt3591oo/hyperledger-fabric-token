...
async function registerUser() {
    return new Promise((resolve, reject) => {
        ...
        Fabric_Client.newDefaultKeyValueStore({ path: store_path
            ...
            fabric_ca_client = new Fabric_CA_Client('http://98.19.10.118:7054', null , '', crypto_suite);
        ...
        return fabric_client.createUser(
            ...
            resolvce('User was successfully registered and enrolled and is ready to intreact with the fabric network')
        }).catch((err) => {
